...
// IDL Name: api2
// IDL Path: api2.thrift

var file_api2_thrift_go_types = []interface{}{
	(*EchoRequest)(nil),  // Struct 0: echo2.EchoRequest
	(*EchoResponse)(nil), // Struct 1: echo2.EchoResponse
}
var file_api2_thrift *thrift_reflection.FileDescriptor
var file_idl_api2_rawDesc = []byte{
	0x1f, 0x8b, 0x8, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0xff, 0xac, 0x92, 0xc1, 0x4e, 0xc3, 0x30,
	0x10, 0x44, 0x7, 0x27, 0x69, 0x2, 0x4e, 0x94, 0x23, 0x7c, 0x45, 0xf, 0xfd, 0x5, 0xe0, 0xc2,
	...
	0x0, 0x0, 0xff, 0xff, 0x47, 0x3e, 0x48, 0xe9, 0xe5, 0x3, 0x0, 0x0,
}

func init() {
	if file_api2_thrift != nil {
		return
	}
	type x struct{}
	builder := &thrift_reflection.FileDescriptorBuilder{
		Bytes:         file_idl_api2_rawDesc,
		GoTypes:       file_api2_thrift_go_types,
		GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
	}
	file_api2_thrift = thrift_reflection.BuildFileDescriptor(builder)
}

func GetFileDescriptorForApi2() *thrift_reflection.FileDescriptor {
	return file_api2_thrift
}
func (p *EchoRequest) GetDescriptor() *thrift_reflection.StructDescriptor {
	return file_api2_thrift.GetStructDescriptor("EchoRequest")
}

func (p *EchoRequest) GetTypeDescriptor() *thrift_reflection.TypeDescriptor {
	ret := thrift_reflection.NewTypeDescriptor()
	ret.Filepath = file_api2_thrift.Filepath
	ret.Name = "EchoRequest"
	return ret
}
func (p *EchoResponse) GetDescriptor() *thrift_reflection.StructDescriptor {
	return file_api2_thrift.GetStructDescriptor("EchoResponse")
}
